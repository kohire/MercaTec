 ...
 * 
 */
@WebServiceClient(name = "UsuarioWS", targetNamespace = "http://usuarios.mercatec/", wsdlLocation = "http://localhost:8080/UsuariosWS/UsuarioWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USUARIOWS_QNAME = new QName("http://usuarios.mercatec/", "UsuarioWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/UsuariosWS/UsuarioWS?wsdl");
    ...
    public UsuarioWS getUsuarioWSPort() {
        return super.getPort(new QName("http://usuarios.mercatec/", "UsuarioWSPort"), UsuarioWS.class);
    }
    ...
    public UsuarioWS getUsuarioWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://usuarios.mercatec/", "UsuarioWSPort"), UsuarioWS.class, features);
    }
